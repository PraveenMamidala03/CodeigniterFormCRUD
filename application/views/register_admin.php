...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand"><b>Admin Register User</b></a>
  <form class="form-inline">
    <a href="<?php echo base_url() ?>admin/users_list"> <button type="button" class="btn btn-success">Users List</button> </a> 
  </form>
</nav>
...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<form method="post" action="<?php echo base_url() ?>admin/register_action " enctype='multipart/form-data' >
